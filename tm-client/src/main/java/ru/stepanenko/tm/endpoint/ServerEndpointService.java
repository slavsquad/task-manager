 ...
 * 2019-05-29T00:57:25.729+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "ServerEndpointService",
                  wsdlLocation = "http://localhost:8080/ServerEndpoint?wsdl",
...
public class ServerEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/ServerEndpoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServerEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/ServerEndpoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
