...
public interface ProjectEndpoint {
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/findAllProjectByPartOfNameOrDescriptionRequest", output = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/findAllProjectByPartOfNameOrDescriptionResponse", fault = {@FaultAction(className = InputDataValidateException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/findAllProjectByPartOfNameOrDescription/Fault/InputDataValidateException"), @FaultAction(className = AuthenticationSecurityException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/findAllProjectByPartOfNameOrDescription/Fault/AuthenticationSecurityException")})
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/sortAllProjectByUserIdRequest", output = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/sortAllProjectByUserIdResponse", fault = {@FaultAction(className = InputDataValidateException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/sortAllProjectByUserId/Fault/InputDataValidateException"), @FaultAction(className = AuthenticationSecurityException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/sortAllProjectByUserId/Fault/AuthenticationSecurityException")})
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/createProjectRequest", output = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/createProjectResponse", fault = {@FaultAction(className = InputDataValidateException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/createProject/Fault/InputDataValidateException"), @FaultAction(className = AuthenticationSecurityException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/createProject/Fault/AuthenticationSecurityException")})
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/findOneProjectRequest", output = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/findOneProjectResponse", fault = {@FaultAction(className = InputDataValidateException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/findOneProject/Fault/InputDataValidateException"), @FaultAction(className = AuthenticationSecurityException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/findOneProject/Fault/AuthenticationSecurityException")})
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/editProjectRequest", output = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/editProjectResponse", fault = {@FaultAction(className = InputDataValidateException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/editProject/Fault/InputDataValidateException"), @FaultAction(className = AuthenticationSecurityException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/editProject/Fault/AuthenticationSecurityException")})
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/removeAllProjectByUserIdRequest", output = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/removeAllProjectByUserIdResponse", fault = {@FaultAction(className = InputDataValidateException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/removeAllProjectByUserId/Fault/InputDataValidateException"), @FaultAction(className = AuthenticationSecurityException_Exception.class, value = "http://endpoint.tm.stepanenko.ru/ProjectEndpoint/removeAllProjectByUserId/Fault/AuthenticationSecurityException")})
