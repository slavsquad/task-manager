...
public class ProjectEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.stepanenko.ru/", "ProjectEndpointService");
    public final static QName ProjectEndpointPort = new QName("http://endpoint.tm.stepanenko.ru/", "ProjectEndpointPort");
    static {
        URL url = null;
        try {
