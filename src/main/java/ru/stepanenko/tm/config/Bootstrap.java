...
public class Bootstrap {
    ...
    public void init() {
        ...
        for (Project project : projectService.findAll(userService.findByLogin("admin").getId())) {
            taskService.create("task_100", "Description for task 100", project.getId());
            taskService.create("task_200", "Description for task 200", project.getId());
            taskService.create("task_300", "Description for task 300", project.getId());
            taskService.create("task_400", "Description for task 400", project.getId());
        }
